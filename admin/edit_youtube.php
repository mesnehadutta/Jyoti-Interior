...
$sql1=mysqli_query($con,"SELECT * FROM you_tube_links where ID='" . $_GET["ID"] . "'");
...
if (isset($_POST['update']))  
{
    ...
    $sql3  = "UPDATE you_tube_links SET link='$link',description='$description' WHERE id='" . $_GET["ID"] . "'";
...
<meta charset="utf-8" />
<title>Edit You Tube Links</title>
...
<label>Link</label>
<div>
<input type="text" class="form-control" required="" name="link" placeholder="Link" value="<?php echo $result1['link'] ?>">
</div>
</div>
<div class="mb-3">
<label>Link Description</label>
<div>
<input type="text" class="form-control" required="" name="description" placeholder="Link Description" value="<?php echo $result1['description'] ?>">
</div>
</div>
...
<a href="display_youtube_links.php"  class="btn btn-secondary waves-effect" >Cancel </a>
</div>
</div>
</form>
